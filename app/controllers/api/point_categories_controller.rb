class Api::PointCategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @point_category.save
        format.html { redirect_to @point_category, notice: 'PointCategory was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @point_category.update_attributes(params[:point_category])
        format.html { redirect_to @point_category, notice: 'PointCategory was successfully updated.' }
